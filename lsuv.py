...
"""+ bcolors.BLUE +"""noLog"""+ bcolors.END +""" prevents from logging. By default, a log is output not just on screen, but also into [initialised.caffemodel].log
        ...
        if post_init != '':
            ...
            if post_init == 'neurons':
                ...
                if set_mean!= -999:
                    ...
                    print('\n', bcolors.YELLOW, 'Per-neuron maximum mean activation shifts due to weight influence used to be', maxD,'and', minD,'for positive and negative directions.', bcolors.END)
...
print ('Initialization took',(end - startTime)*1000., 'seconds')
